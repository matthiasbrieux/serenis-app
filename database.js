...
const newCols = [
  ...
  "ALTER TABLE visits ADD COLUMN buyer_budget TEXT",
  "ALTER TABLE visits ADD COLUMN buyer_financing TEXT",
  "ALTER TABLE visits ADD COLUMN buyer_timeline TEXT",
  ...
  "ALTER TABLE sellers ADD COLUMN assigned_to TEXT",
  "ALTER TABLE sellers ADD COLUMN assigned_at TEXT",
