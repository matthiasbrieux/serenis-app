...
app.get('/contrat-prestation', (req, res) => { res.set('Cache-Control', 'no-store, no-cache, must-revalidate'); res.sendFile(path.join(__dirname, 'public', 'contrat-prestation.html')); });
...
app.get('/dossier-complet', require('./middleware/auth').requireAdmin, (req, res) => { res.set('Cache-Control', 'no-store, no-cache, must-revalidate'); res.sendFile(path.join(__dirname, 'public', 'dossier-complet.html')); });
app.get('/formation-complete', require('./middleware/auth').requireAdmin, (req, res) => { res.set('Cache-Control', 'no-store, no-cache, must-revalidate'); res.sendFile(path.join(__dirname, 'public', 'formation-complete.html')); });
app.get('/fiche-fondateurs', require('./middleware/auth').requireAdmin, (req, res) => { res.set('Cache-Control', 'no-store, no-cache, must-revalidate'); res.sendFile(path.join(__dirname, 'public', 'fiche-fondateurs.html')); });
app.get('/hoguet-defense', require('./middleware/auth').requireAdmin, (req, res) => { res.set('Cache-Control', 'no-store, no-cache, must-revalidate'); res.sendFile(path.join(__dirname, 'public', 'hoguet-defense.html')); });
app.get('/dossier-conviction', require('./middleware/auth').requireAdmin, (req, res) => { res.set('Cache-Control', 'no-store, no-cache, must-revalidate'); res.sendFile(path.join(__dirname, 'public', 'dossier-conviction.html')); });
app.get('/dossier', require('./middleware/auth').requireAdmin, (req, res) => { res.set('Cache-Control', 'no-store, no-cache, must-revalidate'); res.sendFile(path.join(__dirname, 'public', 'dossier.html')); });
...
app.listen(PORT, () => {
  ...
  const { sendVisitReminders, sendMissionReminders, sendAutomatedNudges, sendContractExpiryReminders, sendPostVisitBuyerNudges, sendPostVisitDossierNudges, sendPostVisitJ3Nudges, sendPostFirstVisitFeedbackNudges, sendCheckInNoOfferNudges, sendPriceDropNudges } = require('./services/reminders');
